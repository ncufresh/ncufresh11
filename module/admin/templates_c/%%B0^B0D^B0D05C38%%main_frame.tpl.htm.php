<?php /* Smarty version 2.6.26, created on 2011-07-29 02:33:20
...
<body>
	<!--[if let IE 6]>
	 <div style="background:#DDECFF; padding:10px; border:#FFFFFF sodivd 5px; font-size: 12px; margin: auto;">
        ...
        <div id="logo">
        	<div id="top">
				<form action="indexddd.php" method="post">
					<span id="online"><?php echo $this->_tpl_vars['main_block_var']['ondivne_counter']; ?>
</span>
    	...
    	<?php if (! $this->_tpl_vars['curruser']->is_login()): ?>
    		<div id="sidebar_right">
				...
				<div id="rightbox_end_bac">
					<a id="play" href="login.php?action=logout"></a>
				</div>
